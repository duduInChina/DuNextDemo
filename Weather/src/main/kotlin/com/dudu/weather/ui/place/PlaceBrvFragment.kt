...
class PlaceBrvFragment : BaseFragment() {
    ...
    override fun initFlow() {
        launchAndRepeatWithViewLifecycle {
            viewModel.loadingViewLiveData.observe(this@PlaceBrvFragment) {
                when (it) {
                    LoadingViewStatus.LoadingView -> bodyBinding.searchPlaceLoading.visibility = View.VISIBLE
                    LoadingViewStatus.LoadingHide -> bodyBinding.searchPlaceLoading.visibility = View.GONE
                    else -> {}
                }
            }
        }
